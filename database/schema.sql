...
CREATE TABLE IF NOT EXISTS departments (
    ...
    slug VARCHAR(100) NOT NULL UNIQUE, -- e.g., 'library', 'accounts'
...
CREATE TABLE IF NOT EXISTS users (
    ...
    department_id INT NULL, -- Linked if role is 'department'
...
CREATE TABLE IF NOT EXISTS students (
    ...
    is_boarder BOOLEAN DEFAULT FALSE, -- Hostel Status
...
CREATE TABLE IF NOT EXISTS clearance_requests (
    ...
    purpose ENUM('degree', 'provisional_certificate', 'transcript', 'admission_cancellation', 'hostel_cancellation', 'synopsis_submission', 'thesis_submission') NOT NULL,
    status ENUM('pending', 'in_progress', 'completed', 'rejected') DEFAULT 'pending',
    request_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    completed_date TIMESTAMP NULL,
    certificate_path VARCHAR(255) NULL, -- Path to generated PDF
    verification_code VARCHAR(100) NULL UNIQUE, -- For QR Code
...
CREATE TABLE IF NOT EXISTS clearance_steps (
    ...
    approved_by INT NULL, -- User ID of the approver
    remarks TEXT NULL,
...
CREATE TABLE IF NOT EXISTS fees (
    id INT AUTO_INCREMENT PRIMARY KEY,
    student_id INT NOT NULL,
    fee_type ENUM('university_fee', 'hostel_fee', 'transcript_fee', 'degree_fee') NOT NULL,
...
INSERT IGNORE INTO departments (name, slug) VALUES 
